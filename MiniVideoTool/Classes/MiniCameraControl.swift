...
protocol MiniCameraControlDelegate: class {
...
class MiniCameraControl: UIView {
    
    weak open var delegate: MiniCameraControlDelegate?
    ...
    override init(frame: CGRect) {
        ...
        retakeButton.setBackgroundImage(UIImage(named: "icon_return"), for: .normal)
        ...
        takeButton.setBackgroundImage(UIImage(named: "icon_finish"), for: .normal)
        takeButton.addTarget(self, action: #selector(takeButtonClick), for: .touchUpInside)
        self.addSubview(takeButton)
        
        changeCameraButton.setImage(UIImage(named: "change_camera"), for: .normal)
        ...
        exitButton.setImage(UIImage(named: "arrow_down"), for: .normal)
